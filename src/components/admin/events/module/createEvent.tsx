...
export default function CreateEventForm() {
  ...
  const [formData, setFormData] = useState<CreateEventPayload & { startDate: string; endDate: string }>(
    {
      name: "",
      description: "",
      startDate: "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormData({ name: "", description: "", startDate: "", endDate: "", year: new Date().getFullYear(), month: new Date().getMonth() + 1 })
    } catch (err: any) {
